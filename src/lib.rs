...
#[derive(Debug)]
pub struct PrimeDataProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeDataProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeData processing");
    
    let mut processor = PrimeDataProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeDataProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeDataProcessor::new(false);
